    ...
    listeners:
      ...
      - name: external
        ...
        configuration:
          ...
          brokers:
          - broker: 0
            advertisedHost: my-cluster.kafka.3.38.104.137.nip.io    # 각자의 Node IP로 변경
            nodePort: 32200
          - broker: 1
            advertisedHost: my-cluster.kafka.3.38.104.137.nip.io    # 각자의 Node IP로 변경
            nodePort: 32201
...
...
  - addresses:
    - host: my-cluster.kafka.3.38.104.137.nip.io
      port: 32100
    bootstrapServers: my-cluster.kafka.3.38.104.137.nip.io:32100
    name: external
    type: external
...
my-cluster.kafka.34.xx.xx.xx.nip.io -->
my-cluster.kafka.3.38.104.137.nip.io

bootstrap  : my-cluster.kafka.3.38.104.137.nip.io:32100
broker0    : my-cluster.kafka.3.38.104.137.nip.io:32200
broker1    : my-cluster.kafka.3.38.104.137.nip.io:32201
broker2    : my-cluster.kafka.3.38.104.137.nip.io:32202


# port 가 살아 있는지 netcat 으로 확인해 보자.
$ nc -zv my-cluster.kafka.3.38.104.137.nip.io 32100
Connection to my-cluster.kafka.3.38.104.137.nip.io (34.xx.xx.xx) 32100 port [tcp/*] succeeded!
...
$ nc -zv my-cluster.kafka.3.38.104.137.nip.io 32203
...
export BROKERS=my-cluster.kafka.3.38.104.137.nip.io:32100
export KAFKAUSER=my-edu-admin
export PASSWORD=Gma5yRtb2qCZfaplgF4qRWpUCd1fsKOY        ## 개인별 passwrod 붙여넣자.   위 3.2 KafkaUser 를 참고하자. 
export TOPIC=my-topic
...
Metadata for all topics (from broker -1: sasl_plaintext://my-cluster.kafka.3.38.104.137.nip.io:32100/bootstrap):
 3 brokers:
  broker 0 at my-cluster.kafka.3.38.104.137.nip.io:32200
  broker 2 at my-cluster.kafka.3.38.104.137.nip.io:32202 (controller)
  broker 1 at my-cluster.kafka.3.38.104.137.nip.io:32201
 1 topics:
  topic "my-topic" with 3 partitions:
...
$ nc -zv my-cluster.kafka.3.38.104.137.nip.io 32100
Connection to my-cluster.kafka.3.38.104.137.nip.io (34.130.165.53) 32100 port [tcp/*] succeeded!
...
# 개인환경으로 변경
bootstrap_servers='my-cluster.kafka.3.38.104.137.nip.io:32100'
sasl_plain_password='Gma5yRtb2qCZfaplgF4qRWpUCd1fsKOY'             ## 개인별 passwrod 붙여넣자.   위 3.2 KafkaUser 를 참고하자. 
sasl_plain_username='my-edu-admin'
topic_name='my-topic' 
group_id='my-topic-group'
...
export TOPIC=edu-topic02         # <-- 본인 topic명으로 지정
export GROUP=edu-topic02-cg      # <-- 본인 group명으로 지정
...
topic_name='edu-topic02'         # <-- 본인 topic명으로 지정
group_id='edu-topic02-cg'        # <-- 본인 group명으로 지정
...
# 구독 확인
consumer.subscription()
#{'edu-topic02'}            <-- 본인의 Topic이 출력되어야 한다.
...
sasl_plain_username='edu-user'
sasl_plain_password='oXTjENLJMvdKV6CbQmU2NX0e87Rezxhc'
topic_name='edu-topic02'      # <-- 본인 타픽명으로 지정
...
```sh
# topic
edu-topic02 ~ edu-topic20
 
# group - 사용자가 consum 할때 선언함
edu-topic02-cg ~ edu-topic20-cg
