...
def consumer(group_id='edu-topic01-a1-cg', auto_offset_reset='latest'):
    ...
    topic_name=config["KAFKAINFO"]["topic_name_a"]
    group_id=group_id
    """
    ...
    print(f"KafkaConsumer group_id[{group_id}] auto_offset_reset[{auto_offset_reset}]  ...")
