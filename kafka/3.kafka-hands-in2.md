...
$ python 25.producer-spt-ack.py edu-topic01-b 50000 0
$ python 25.producer-spt-ack.py edu-topic01-b 50000 1
$ python 25.producer-spt-ack.py edu-topic01-b 50000 all
...
$ python 30.producer-spt-batch-linger.py edu-topic01-b 50000 16384 3000
$ python 30.producer-spt-batch-linger.py edu-topic01-b 50000 32768 3000
$ python 30.producer-spt-batch-linger.py edu-topic01-b 50000 65536 3000
...
$ python 41.consumer-offset-reset.py edu-topic01-a edu-topic01-a1-cg latest


# 로그를 확인해보자.
KafkaConsumer topicName[edu-topic01-a] group_id[edu-topic01-a1-cg] auto_offset_reset[latest]  ...
Consuming...
...
$ python 41.consumer-offset-reset.py edu-topic01-a edu-topic01-a2-cg earliest

# 로그를 확인해보자.
KafkaConsumer topicName[edu-topic01-a] group_id[edu-topic01-a2-cg] auto_offset_reset[earliest]  ...
Consuming...

...
topic=edu-topic01-a partition=1 offset=19: key=b'key3' value=b'{"eventName":"a","num":6,"title":"a", "writeId":"", "writeName": "", "writeDate":"" }'
topic=edu-topic01-a partition=1 offset=20: key=b'key3' value=b'{"eventName":"a","num":7,"title":"a", "writeId":"", "writeName": "", "writeDate":"" }'
topic=edu-topic01-a partition=1 offset=21: key=b'key3' value=b'{"eventName":"a","num":8,"title":"a", "writeId":"", "writeName": "", "writeDate":"" }'
topic=edu-topic01-a partition=1 offset=22: key=b'key3' value=b'{"eventName":"a","num":9,"title":"a", "writeId":"", "writeName": "", "writeDate":"" }'
...
...
```sh
$ python 41.consumer-offset-reset.py edu-topic01-a edu-topic01-a1-cg earliest
...
# 대량 데이터 전송
# args : topic, 발송건수
$ python 47.producer-spt-ack.py edu-topic01-b 50000

KafkaProducer...
topicName[edu-topic01-b] range_cnt[50000] Producing...
...
# args : topic, group-id, auto_offset_reset
$ python 45.consumer-poll.py edu-topic01-b edu-topic01-b-cg latest
...
...
TopicPartition(topic='edu-topic01-b', partition=0) 500
TopicPartition(topic='edu-topic01-b', partition=0) 500
TopicPartition(topic='edu-topic01-b', partition=0) 249
...
# args : topic, group-id, auto_offset_reset
$ python 45.consumer-poll.py edu-topic01 edu-topic01-cg latest
...
# 1) 10개 데이터를 보내 보자.
# args : topic, 
$ python 52.producer-10pub.py edu-topic01
...
# 1) consumer 수행
# args : topic, group-id
$ python 51.consumer-commit-60s.py edu-topic01 edu-topic01-cg
