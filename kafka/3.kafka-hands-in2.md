...
대량의 데이터(30,000건) 전송하는 테스트를 수행하면서 처리속도를 보자.
...
$ python ./kafka/PythonSample/25.producer-spt-ack.py 0
$ python ./kafka/PythonSample/25.producer-spt-ack.py 1
$ python ./kafka/PythonSample/25.producer-spt-ack.py all


# 로그를 확인해보자.
topicName[edu-topic01-b] ack[0] Producing...
duration time : 2.6880788803100586

topicName[edu-topic01-b] ack[1] Producing...
duration time : 2.7109756469726562

topicName[edu-topic01-b] ack[all] Producing...
duration time : 2.7397985458374023
...
KafkaProducer...
topicName[edu-topic01-b] batch_size[16384] linger_ms[0] Producing...
duration time : 4.738646507263184

topicName[edu-topic01-b] batch_size[32768] linger_ms[0] Producing...
duration time : 4.447396278381348

topicName[edu-topic01-b] batch_size[65536] linger_ms[0] Producing...
duration time : 4.275187015533447
