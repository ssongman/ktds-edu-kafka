...
# 소스 확인
$ cat ./kafka/PythonSample/51.producer-10pub.py
...

# 1) 10개 데이터를 보내 보자.
# args : range-cnt
$ python ./kafka/PythonSample/51.producer-10pub.py
...
auto_commit_interval_ms 이 60초로 셋팅된 consumer 로 consume 한다음 바로 종료하자.
